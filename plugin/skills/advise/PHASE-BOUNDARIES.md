...
| **`/supermatt:handoff`** | Write a portable markdown file and seed a session anywhere with it. |
...
**3. Do you need to hand off?** `/supermatt:handoff` is narrow. You need it only when you are:
...
That list is the whole clause. What `/supermatt:handoff` buys is **portability**: a file that travels. If nothing is travelling, you don't need it.
...
| Secondary (`/compact`, `/supermatt:handoff`) | Lossy       | Less  | Lots         |
