...
- **green_before_stop**: a turn cannot end while uncommitted code fails the tests, except mid-ticket (`implementing`), where red is part of test-first work; after three blocked stops in a row it lets go and tells the user.
