...
![Ticket states: implementing, needs-review, done, and blocked while Claude waits on your answer](images/ticket-states.png)
...
![The end-of-turn check: the questions supermatt asks before letting Claude end its turn](images/end-of-turn.png)
